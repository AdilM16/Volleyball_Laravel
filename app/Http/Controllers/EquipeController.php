...
class EquipeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.equipes.allequipes', compact('equipes', 'continents'));
    }
    ...
    public function create()
    {
        $equipes = Equipe::all();
        $continents = Continent::all();
        return view("pages.equipes.createequipe", compact('equipes', 'continents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $store->joueurmax = $request->joueurmax;
