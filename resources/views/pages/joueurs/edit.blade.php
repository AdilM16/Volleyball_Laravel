    ...
    <section>
        <div class="container mt-5">
            <form action="/joueur/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
                ...
                @method('PUT')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  greenLime">Nom:</label>
                    <input type="text" name="nom" value="{{ $edit->nom }}" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  greenLime">Prenom:</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  greenLime">Télephone:</label>
                    <input type="number" name="telephone" value="{{ $edit->telephone }}" class="form-control"
                        id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  greenLime">Email:</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  greenLime">Pays:</label>
                ...
                <div>
                    <label for="exampleInputEmail1" class="form-label  greenLime">Équipe :</label>
